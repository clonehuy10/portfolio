  ...
  return (
    <div>
      <div>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="flex-grow-1">
                  ...
                  <div className='subheading'>Fullstack Software Engineering</div>
              </div>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="flex-grow-1">
                  ...
                  <div className='subheading'>Accounting</div>
              </div>
      ...
      <div className='mt-10'>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="flex-grow-1">
                  <h4 className="mb-3 textFieldTitle">Nail Technician</h4>
                  <div className="subheading mb-3">MiniLuxe and AerNailBar</div>
                  <div className='subheading'>Provide manicures and pedicure services, and ensure clients receive the highest levels of service quality possible.</div>
              </div>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="flex-grow-1">
                  <h4 className="mb-3 textFieldTitle">Tax Preparer</h4>
                  <div className="subheading mb-3">Bunker Hill Community College</div>
                  <div className='subheading'>Volunteer Income Tax Assistance at Tax Site</div>
              </div>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="flex-grow-1">
                  <h4 className="mb-3 textFieldTitle">Machine Operator</h4>
                  <div className="subheading mb-3">Micro Tech Staffing</div>
                  <div className='subheading'>Responsible for operating the machinery in the automation line. Ensure product quality according to company's quality requirements.</div>
              </div>
          ...
          <div className="d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="flex-grow-1">
                  <h4 className="mb-3 textFieldTitle">Cashier</h4>
                  <div className="subheading mb-3">CVS</div>
                  <div className='subheading'>Help with stocking and merchandising to maximize sales for store and provide a pleasant shopping experience for customers.</div>
              </div>
